...
class DetectCancerScreen extends StatefulWidget {
  const DetectCancerScreen({Key? key}) : super(key: key);

  @override
  _DetectCancerScreenState createState() => _DetectCancerScreenState();
}

class _DetectCancerScreenState extends State<DetectCancerScreen> {
